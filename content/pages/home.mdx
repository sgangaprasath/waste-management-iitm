...
blocks:
  - background: bg-default
    headline: Waste Management Portal
    tagline: One stop info-station for waste handling on IIT Madras campus
    actions:
  ...
  - title: Contact
    description: >-
      ...
      out at waste@iitm.ac.in.
    actions:
      - label: Write to us
        type: button
        icon:
          color: white
        link: 'emailto:waste@iitm.ac.in'
    _template: cta
---
